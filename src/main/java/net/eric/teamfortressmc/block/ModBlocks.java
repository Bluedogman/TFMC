package net.eric.teamfortressmc.block;

import net.eric.teamfortressmc.TeamFortressMc;
import net.eric.teamfortressmc.block.custom.SoundBlock;
...
public class ModBlocks {
    public static final DeferredRegister<Block> BLOCKS =
            DeferredRegister.create(ForgeRegistries.BLOCKS, TeamFortressMc.MOD_ID);
